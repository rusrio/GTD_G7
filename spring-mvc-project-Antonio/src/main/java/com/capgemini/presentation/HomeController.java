...
public class HomeController {
	...
	/**
	 * Este método se encarga de iniciar la BBDD con algunos datos, para que podamos trabajar
	 * con la app. Posteriormente podremos borrar los datos aquí introducidos
	 * Solamente se ejecuta una vez, si el usuario admin no esta creado, gracias al condicional
	...
	/**
	 * Con este controlador, mostramos la página de login cuando accedemos al server.
	 * Desde aquí se ejecutaría el método inicio() (arriba explicado)
	 * */
	@GetMapping("/")
	public String login() {
	 ...
	 * 
	 * Si user existe y pwd es correcta, comprobamos si es el admin, y lo redirigimos
	 * a su home page
	 * 
	 * Si no es el admin, comprobamos si está habilitado o no
	 * HABILITADO = devolvemos su home page
	 * DESAHBILITADO = devolvemos la pagina de login con un mensaje indincando esta situacion
	 * */
	...
	/**
	 * Con este controlador mostramos el home si nos logueamos como admin
	 * Desde aqui podremos ver una lista con todos los usuario (quitamos el admin)
	 *
	 * Pasamos una lista con los usuarios para gestionarlos y el mismo admin,
	 * para poder modificar sus datos personales
	 */
	@GetMapping("/admin")
	...
	/**
	 * Con este controlador eliminamos un usuario, y redirigimos al home
	 * del administrador
	 * 
	...
	/**
	 * Con este controlador habilitamos/desahabilitamos un usuario, y redirigimos 
	 * al home del administrador
	 * 
	 * Solamente se puede acceder a este método desde el home del admin
	 * */
	...
	/**
	 * Con este controlador, devolvemos la vista para el registro de un nuevo usuario
	 * pasándole un objeto UserVO, que será el que posteriormente persisteremos en la BBDD
	 * */
	 ...
	 * 
	 * Primero comprobamos que no haya un usuario ya con ese login, puesto que el login es
	 * unico y saltaría una excepción al intentar persistirlo en BBDD
	 * Volvemos a devolver la página de registro con un mensaje indicandolo en caso de que
	 * asi sea
	 * 
	 * Si los datos son correctos, hacemos setters a los valores por defecto que tendrá
	 * el usuario, y persistimos
	 * 
	 * Devolvmos la página de login con un mensaje para que prueba sus nuevas credenciales
	 * */
	...
	/**
	 * Con este controlador, devolvemos la vista para modificar un  usuario
	 * pasándole el id del objeto UserVO a modificar
	 * */
	 ...
	 * 
	 * Lo pasamos como parámetro y lo buscamos en la BBDD, a ese usuario buscado,
	 * le actualizamos los valores que hemos cambiado, y lo modificamos en BBDD
	 * */
	...
	/**
	 * Con este controlador, listamos las categorias de cada usuario
	 * Se accede desde la propia pagina del usuario, y le pasamos su id
	 * como parametro, la cual usaremos para buscarlo en BBDD y obtener
	 * la lista con sus categorias asociadas
	 * 
	 * Las añadimos al modelo, asi como el objeto usuario que nos ha llamado
	 * al controlador
	 */
	...
	/**
	 * Con este controlador eliminamos una categoria, y redirigimos a la 
	 * vista de las categorias del usuario al que pertenecen
	 * 
	...
	/**
	 * Con este controlador, devolvemos la vista para el registro de una nueva categoria
	 * pasándole un objeto CategoryVO, que será el que posteriormente persisteremos en la BBDD
	 * y un objeto UserVO, que sera el propietario de la categoria
	 * */
	 ...
	 * 
	 * Le añadimos el usuario, que pasamos como iduser y lo buscamos
	 * y un arraylist de tareas vacio que se ira rellenando cada vez que 
	 * creemos una tarea asociada a esta categoria 	
	 * */
	 ...
	 * 
	 * La pasamos como parámetro y la buscamos en la BBDD,
	 * le actualizamos los valores que hemos cambiado, y la modificamos en BBDD
	 * */
